...
const WORKSHEETS: Worksheet[] = [
  { id:"ws1",  title:"ABC Tracing Practice",       emoji:"✏️", bg:"bg-blue-100",    accent:"#3B82F6", fileUrl:"https://drive.google.com/file/d/your-abc-worksheet-id/view",       ageMin:24, ageMax:60,  subject:"Literacy" },
  { id:"ws2",  title:"1–10 Number Counting",       emoji:"🔢", bg:"bg-green-100",   accent:"#10B981", fileUrl:"https://drive.google.com/file/d/your-counting-worksheet-id/view",  ageMin:24, ageMax:60,  subject:"Math" },
  { id:"ws3",  title:"Color the Farm Animals",     emoji:"🐄", bg:"bg-orange-100",  accent:"#F97316", fileUrl:"https://drive.google.com/file/d/your-animals-worksheet-id/view",   ageMin:24, ageMax:72,  subject:"Art" },
  { id:"ws4",  title:"Match the Shapes",           emoji:"🔵", bg:"bg-purple-100",  accent:"#8B5CF6", fileUrl:"https://drive.google.com/file/d/your-shapes-worksheet-id/view",    ageMin:24, ageMax:60,  subject:"Math" },
  { id:"ws5",  title:"Big & Small Sort",           emoji:"🐘", bg:"bg-amber-100",   accent:"#D97706", fileUrl:"https://drive.google.com/file/d/your-bigsmall-worksheet-id/view",  ageMin:24, ageMax:54,  subject:"Logic" },
  { id:"ws6",  title:"Write My Name Practice",     emoji:"✨", bg:"bg-pink-100",    accent:"#EC4899", fileUrl:"https://drive.google.com/file/d/your-name-worksheet-id/view",      ageMin:36, ageMax:84,  subject:"Literacy" },
  { id:"ws7",  title:"Spot the Difference",        emoji:"👀", bg:"bg-teal-100",    accent:"#14B8A6", fileUrl:"https://drive.google.com/file/d/your-spot-worksheet-id/view",      ageMin:36, ageMax:96,  subject:"Logic" },
  { id:"ws8",  title:"Connect the Dots – Stars",   emoji:"🌟", bg:"bg-yellow-100",  accent:"#EAB308", fileUrl:"https://drive.google.com/file/d/your-dots-worksheet-id/view",      ageMin:36, ageMax:84,  subject:"Art" },
  { id:"ws9",  title:"Alphabet Coloring A–Z",      emoji:"🎨", bg:"bg-rose-100",    accent:"#F43F5E", fileUrl:"https://drive.google.com/file/d/your-alphabet-worksheet-id/view",  ageMin:36, ageMax:72,  subject:"Literacy" },
  { id:"ws10", title:"Simple Addition Fun",        emoji:"➕", bg:"bg-indigo-100",  accent:"#6366F1", fileUrl:"https://drive.google.com/file/d/your-addition-worksheet-id/view",  ageMin:48, ageMax:96,  subject:"Math" },
  { id:"ws11", title:"Hindi Varnamala Tracing",    emoji:"हि",  bg:"bg-emerald-100", accent:"#059669", fileUrl:"https://drive.google.com/file/d/your-hindi-worksheet-id/view",     ageMin:36, ageMax:84,  subject:"Hindi" },
  { id:"ws12", title:"My Body Parts Worksheet",    emoji:"🧍", bg:"bg-sky-100",     accent:"#0EA5E9", fileUrl:"https://drive.google.com/file/d/your-body-worksheet-id/view",      ageMin:24, ageMax:72,  subject:"Science" },
  { id:"ws13", title:"Fruits & Vegetables Match",  emoji:"🍎", bg:"bg-lime-100",    accent:"#84CC16", fileUrl:"https://drive.google.com/file/d/your-fruits-worksheet-id/view",    ageMin:24, ageMax:72,  subject:"GK" },
  { id:"ws14", title:"Weather Chart Worksheet",    emoji:"🌤️", bg:"bg-cyan-100",    accent:"#06B6D4", fileUrl:"https://drive.google.com/file/d/your-weather-worksheet-id/view",   ageMin:48, ageMax:96,  subject:"Science" },
  { id:"ws15", title:"Multiplication Table 2–5",   emoji:"✖️", bg:"bg-violet-100",  accent:"#7C3AED", fileUrl:"https://drive.google.com/file/d/your-multiply-worksheet-id/view",  ageMin:72, ageMax:96,  subject:"Math" },
  { id:"ws16", title:"Story Sequencing Cards",     emoji:"📖", bg:"bg-fuchsia-100", accent:"#D946EF", fileUrl:"https://drive.google.com/file/d/your-story-worksheet-id/view",     ageMin:60, ageMax:96,  subject:"Literacy" },
  { id:"ws17", title:"Map of India Fill-in",       emoji:"🗺️", bg:"bg-orange-100",  accent:"#EA580C", fileUrl:"https://drive.google.com/file/d/your-map-worksheet-id/view",       ageMin:72, ageMax:96,  subject:"GK" },
  { id:"ws18", title:"Colour the Rangoli",         emoji:"🪔", bg:"bg-red-100",     accent:"#DC2626", fileUrl:"https://drive.google.com/file/d/your-rangoli-worksheet-id/view",   ageMin:36, ageMax:96,  subject:"Art" },
  { id:"ws19", title:"Opposite Words Match",       emoji:"🔄", bg:"bg-blue-100",    accent:"#2563EB", fileUrl:"https://drive.google.com/file/d/your-opposites-worksheet-id/view", ageMin:48, ageMax:84,  subject:"Literacy" },
  { id:"ws20", title:"Clock Reading Practice",     emoji:"⏰", bg:"bg-stone-100",   accent:"#78716C", fileUrl:"https://drive.google.com/file/d/your-clock-worksheet-id/view",     ageMin:60, ageMax:96,  subject:"Math" },
];
