...
export function InfantMode({ childName, ageYears, ageMonths }: InfantModeProps) {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* ── Hero Banner ── */}
      <div className="bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50 border-2 border-pink-200 rounded-3xl p-5">
      ...
      <Card className="rounded-3xl border-2 border-blue-200 bg-blue-50 shadow-none">
        <button
      ...
      {/* ── Memory Moments ── */}
      <MemoryMoments childName={childName} />
